            ...
            <div className="absolute inset-0 flex items-center justify-center w-full px-6 py-12">
                <div className="flex flex-col items-center text-center max-w-[440px] w-full">
                    ...
                    <div className="flex flex-col w-full gap-3">
                        <button className="group relative flex items-center justify-center w-full h-11 px-4 text-[15px] font-medium text-text-primary bg-bg-primary border border-border-default rounded-md hover:bg-bg-hover hover:border-border-light transition-all active:scale-[0.98]">
                            <svg className="absolute left-4 w-[18px] h-[18px]" viewBox="52 42 88 66" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <button className="group relative flex items-center justify-center w-full h-11 px-4 text-[15px] font-medium text-text-primary bg-bg-primary border border-border-default rounded-md hover:bg-bg-hover hover:border-border-light transition-all active:scale-[0.98]">
                            <svg className="absolute left-4 w-[18px] h-[18px]" viewBox="0 0 1831.085 1703.335" xmlns="http://www.w3.org/2000/svg">
                                <path fill="#0A2767" d="M1831.083,894.25c0.1-14.318-7.298-27.644-19.503-35.131h-0.213 l-0.767-0.426l-634.492-375.585 c-2.74-1.851-5.583-3.543-8.517-5.067c-24.498-12.639-53.599-12.639-78.098,0 c-2.934,1.525-5.777,3.216-8.517,5.067L446.486,858.693 l-0.766,0.426c-19.392,12.059-25.337,37.556-13.278,56.948 c3.553,5.714,8.447,10.474,14.257,13.868l634.492,375.585 c2.749,1.835,5.592,3.527,8.517,5.068c24.498,12.639,53.599,12.639,78.098,0 c2.925-1.541,5.767-3.232,8.517-5.068l634.492-375.585 C1823.49,922.545,1831.228,908.923,1831.083,894.25z" />
